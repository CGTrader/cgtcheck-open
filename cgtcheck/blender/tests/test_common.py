...
"""
Tests not tied to any specific check
"""
...
def test_imports_and_registers_checks():
    assert len(cgtcheck.runners.CheckRunner._check_classes) > 0


def test_all_checks_have_version():
    missing_versions = {
