...
"threed/threed/blender/tests" must be set as a current directory.
...
# Retrieve topmost dir named "threed".
PROJECT_DIR = [p for p in Path(__file__).parents if p.name == 'threed'][-1]
