...
"""
Module for general math convenience methods.
"""
from math import log, floor


def is_power_of(value, power):
    return log(value, power).is_integer()


def get_closest_lower_power_of(value, power):
    if value < power:
        return power
    return power ** (floor(log(value, power)))
